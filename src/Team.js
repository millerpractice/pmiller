...
import kairalg from "./neutral lg.png"
import kairamd from "./neutral md.png"
import kairasm from "./neutral sm.png"
import kairaxs from "./neutral xs.png"
...
style={{float: "right", paddingTop: 50}}></ResponsiveImgMaterialUi>
    ...
    maxHeight: "fit-content"}}>
                            ...
                            The artificial intelligence system is working as Dr. Miller’s qualified medical assistant since 2018.
</Typography>
                            <Typography style={{ color: "white", fontSize: "1.15vw", paddingTop: 20, textAlign: "left"}}>
                                ...
                                in the colon with a 95% accuracy rate. Reviewing mammograms’ data  30 times faster than humans, it can make quick judgment call,
                            ...
                            <Typography style={{ color: "white",fontSize: "1.15vw",  textAlign: "left", paddingTop: 20}}>
                                Besides cancer prediction the AI is currently supporting Dr. Miller to diagnose diseases such as asthma, diabetes and skin disease.
    </Typography>
    </Grid>
    </Grid>
                        </Grid>
